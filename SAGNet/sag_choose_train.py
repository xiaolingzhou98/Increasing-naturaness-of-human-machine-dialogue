...
from multi_class_model_utils_ import train
import tensorflow as tf
from multi_class_data_stream_ import DataStream
from multi_class_utils_ import read_file, make_instances, make_corpus, split_train_dev, drop_instances_to_excel
from glove_encoder_encoder import W2VEncoder
...
def train_model():
    ...
    test_augment(drop_path,"data/instances_dev_choose_augment_40_class_4.xlsx")
