...
from judge_data_stream_ import InstanceBatch
...
class AnswerGenerator(object):
        ...
        if self.is_training:
            ...
            if self.optimizer == 'adadelta':
                ...
                optimizer = tf.train.AdamOptimizer(
                    learning_rate=self.learning_rate)
            grads = judge_model_utils_.compute_gradients(self.loss,
                                                  trainable_variables)
    ...
    def init_placeholders(self):
        ...
        if self.is_training:
            ...
            decoder_start_token = tf.ones(
                shape=[self.batch_size, 1], dtype=tf.int32) * judge_utils_.start_token
            decoder_end_token = tf.ones(
                shape=[self.batch_size, 1], dtype=tf.int32) * judge_utils_.end_token
        ...
        char_w2v_embedding_matrix, word_w2v_embedding_matrix = judge_model_utils_. \
        ...
        self.sentiment_representation = tf.get_variable(
            ...
            shape=[3, self.sentiment_polarity_multiple])
    ...
    def build_encoder(self):
        ...
        with tf.variable_scope('encoder'):
            ...
            self.encoder_outputs = self.encoder_outputs1+self.en_out2
        ...
        with tf.variable_scope('decoder'):
            ...
            if self.is_training:
                ...
                start_tokens = tf.ones(
                    [self.batch_size, ], tf.int32) * judge_utils_.start_token
                end_token = judge_utils_.end_token
