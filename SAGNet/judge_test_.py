...
from judge_model_utils_ import decode
import tensorflow as tf
from judge_data_stream_ import DataStream
from judge_utils_ import read_file, make_instances
import pickle
...
if __name__ == "__main__":
    ...
    test_samples = read_file(['data/instances_dev_judge_class.xlsx'])
    ...
    with tf.Graph().as_default():
        ...
        saver.restore(sess, best_path)
                     ...
                     data_stream_choose_dev, 'judge_multi_metric.txt')
