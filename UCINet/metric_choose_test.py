...
import numpy as np
from metric_model_utils import evaluation
from data_stream_final import DataStream
from metric_choose_model import AnswerUnderstander
from bert_encoder import BertEncoder
import matplotlib.pyplot as plt
# from lstm_encoder import LSTMENCODER
from me_utils_final23 import read_file, make_instances_parallel, gather_targets_for_samples, \
    gather_question_dict, gather_question_template


if __name__ == "__main__":
    with open('metric_choose_config.json', encoding='utf-8') as infile:
