...
class W2VEncoder(object):
    def __init__(self, is_train,char_corpus, word_corpus,
        ...
        char_w2v_model = KeyedVectors.load_word2vec_format("/home/nlp/Desktop/GloVe-master/vectors_char_judge1.txt", binary=False)
        word_w2v_model = KeyedVectors.load_word2vec_format("/home/nlp/Desktop/GloVe-master/vectors_word_judge1.txt", binary=False)
