...
##################################################################################################
        ...
        self.acc = names["cor"+str(1)]
        self.loss = names["loss"+str(1)]
        ...
        #self.acc = tf.reduce_all(locals()["cor"+str(1)]+locals()["cor"+str(2)]+locals()["cor"+str(3)]+locals()["cor"+str(4)]+locals()["cor"+str(5)])
        #self.loss = names["loss" + str(1)]+names["loss" + str(2)]+names["loss" + str(3)]+names["loss" + str(4)]+names["loss" + str(5)]
        prediction_list = []
        for i in range(self.max_option_length):
