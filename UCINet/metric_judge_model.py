...
##################################################################################################
        ...
        tri_loss = triplet_loss(names["hid_x"+str(5)],names["hid_xp"+str(5)] , names["hid_xn"+str(5)] , 0.5)
        self.acc = ( locals()["cor_x"+str(1)]+ locals()["cor_xp"+str(1)]+ locals()["cor_xn"+str(1)])/3
        self.loss = (locals()["loss_x" + str(1)]+locals()["loss_xp" + str(1)]+locals()["loss_xn" + str(1)])+(1-self.weight)*tri_loss
